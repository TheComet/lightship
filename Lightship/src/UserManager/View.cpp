#include "Lightship/UserManager/View.h"
...
// ----------------------------------------------------------------------------
UserManagerView::UserManagerView(Context* context) :
    Object(context)
{
    SubscribeToEvent(E_CLIENTCONNECTED, URHO3D_HANDLER(UserManagerView, HandleClientConnected));
    SubscribeToEvent(E_CLIENTIDENTITY, URHO3D_HANDLER(UserManagerView, HandleClientIdentity));
    SubscribeToEvent(E_CLIENTDISCONNECTED, URHO3D_HANDLER(UserManagerView, HandleClientDisconnected));
    SubscribeToEvent(E_NETWORKMESSAGE, URHO3D_HANDLER(UserManagerView, HandleNetworkMessage));
}

// ----------------------------------------------------------------------------
String UserManagerView::GetUsername(Connection* connection) const
{
...
// ----------------------------------------------------------------------------
void UserManagerView::SetUsername(Connection* connection, const String& username)
{
...
// ----------------------------------------------------------------------------
void UserManagerView::HandleClientConnected(StringHash eventType, VariantMap& eventData)
{
}

// ----------------------------------------------------------------------------
void UserManagerView::HandleClientIdentity(StringHash eventType, VariantMap& eventData)
{
...
// ----------------------------------------------------------------------------
void UserManagerView::HandleClientDisconnected(StringHash eventType, VariantMap& eventData)
{
...
// ----------------------------------------------------------------------------
void UserManagerView::HandleNetworkMessage(StringHash eventType, VariantMap& eventData)
{/*
